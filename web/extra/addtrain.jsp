               ...
               <div class='unstackable two fields'>
                ...
                <div class="three fields">
                    ...
                    <div id="first" class="field" style="display: none">
                        ...
                        <div class="two fields" id="dayerror" style="color: red;display: block">
                    ...
                    <div class='field'>
                        ...
                        <div id='content' class="ui card" style="max-height: 150px; overflow-y: auto;margin-top: 2px;width: 400px;margin-top: 0px">
                                    <% 
                                      ...
                                      while(rs.next()){
                                          out.println("<div name='ele' class='ui basic large label' id='"+rs.getString(1)+"' style='cursor: pointer;display:block'><span>"+rs.getString(2)+"</span><div class='ui right floated detail' style=''>"+rs.getString(1)+"</div></div>");
                                      }
                                  }
                                  catch(Exception e){ 
                                      out.println("<h1>"+e+"</h1>");
